...
class Scoreboard:
    ...
    def prep_level(self):
        ...
        level_score = self.stats.level
        level_score_str = f"{level_score}"
        self.level_score_image = self.font.render(
            level_score_str, True, self.text_color, self.settings.bg_color
        )

        # Display the score at the top right of the screen.
        self.level_score_rect = self.score_image.get_rect()
