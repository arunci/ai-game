...
class AlienInvasion:
    ...
    def _update_bullets(self):
        """Update the bullets postion and get rid of the old bullets."""
        self.bullets.update()
    ...
    def _create_fleet(self):
        ...
        # Make an alien and keep adding aliens until there is not space left.
        ...
        while current_y < (self.settings.screen_height - 3 * alien_height):
            ...
            # Finished a row, reset the x value and start a new row.
